        ...
        <div className="splash-div">
          <section className="splash1">
            <div className="splash1-div">
              ...
              <ul>
                <li><button className="splash1-join-button" onClick={this.props.guestLogin}>Login as Guest</button></li>
              </ul>
            </div>
          </section>
          ...
          <section className="splash2">
            ...
            <div className="splash2-top">
              <h2>Explore the World</h2>
              <button className="blue-btn"><Link to='/howitworks'>How It Works</Link></button>
            </div>
            <div className="splash-article">
          ...
          <section className="splash3">
            <div className="splash3-top">
