          ...
          <form className="review-form" onSubmit={this.handleSubmit}>
            <div className="rating-div">
              ...
              <span className="rating">
                ...
                <label for="rating-input-1-5" className="rating-star" id={5}                 onClick={this.handleOptionChange}></label>
                ...
                <label for="rating-input-1-4" className="rating-star" onClick={this.handleOptionChange} id={4}></label>
                ...
                <label for="rating-input-1-3" className="rating-star" onClick={this.handleOptionChange} id={3}></label>
                ...
                <label for="rating-input-1-2" className="rating-star" onClick={this.handleOptionChange} id={2}></label>
                ...
                <label for="rating-input-1-1" className="rating-star" onClick={this.handleOptionChange} id={1}></label>
            </span>
            </div>
            <textarea
